        ...
        <div class="container">
            ...
            <nav aria-label="breadcrumb animated slideInDown">
                <ol class="breadcrumb mb-0">
                    <li class="breadcrumb-item"><a class="text-body" href="{{route('index')}}">Menu</a></li>
            ...
            <div class="row g-5 justify-content-center">
                <div class="col-lg-5 col-md-12 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="bg-primary text-white d-flex flex-column justify-content-center h-100 p-5">
                        ...
                        <p class="mb-5"><i class="fa fa-phone-alt me-3"></i>(19) 3463-2155</p>
                        <h5 class="text-white">Email</h5>
                        <p class="mb-5"><i class="fa fa-envelope me-3"></i>ebacchin@agroinsumos.com.br</p>
                        <h5 class="text-white">Localização</h5>
                        <p class="mb-5"><i class="fa fa-map-marker-alt me-3"></i>R. dos Tupis, 1158 - Jardim São Francisco, Santa Bárbara d'Oeste - SP, 13456-032</p>
                    </div>
                </div>
        ...
        <div class="container py-5">
            <div class="row g-5">
                <div class="col-lg-3 col-md-6">
                    ...
                    <p class="mb-2"><i class="fa fa-phone-alt me-3"></i>(19) 3463-2155</p>
                    <p class="mb-2"><i class="fa fa-envelope me-3"></i>ebacchin@agroinsumos.com.br</p>
