...
@section('content')
    ...
    <div class="container-fluid page-header-produtos wow fadeIn" data-wow-delay="0.1s">
        <div class="container text-center">
            <h1 class="display-3 mb-3 text-white animated slideInDown">Trigo</h1>
            <nav aria-label="breadcrumb animated slideInDown">
                <ol class="breadcrumb justify-content-center mb-0">
                    ...
                    <li class="breadcrumb-item text-body active" aria-current="page">Trigo</li>
                </ol>
            </nav>
        </div>
    </div>
                            ...
                            <div class="product-item">
                                <!--<div class="position-relative">
                                    ...
                                    <div class="product-overlay">
                                        <img class="img-fluid" style="width: 200px;" src="" alt="">
                                    </div>
                                </div>-->
