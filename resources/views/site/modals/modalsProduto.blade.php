<!-- albandeirante -->
<div class="modal fade" id="albandeirante" tabindex="-1" role="dialog" aria-labelledby="albandeirante" aria-hidden="true">
                ...
                <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
                  <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img class="d-block w-100" src="{{asset('img/products/sementes/al-bandeirante.png')}}">
                    </div>

                    <div class="carousel-item">
                        <img class="d-block w-100" src="{{asset('img/products/sementes/al-avare.png')}}">
                    </div>
