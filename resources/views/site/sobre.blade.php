        ...
        <div class="container">
            ...
            <div class="row g-5 align-items-center">
                ...
                <div class="col-lg-6 order-1 order-lg-2 text-center" data-aos="fade-up" data-aos-delay="200">
                    <img src="{{asset('img/about/primeiro-produto.png')}}" alt="" style="width: 700px">
                </div>
            </div>
        ...
        <div class="container-xxl py-5-5 alt-services">
            <div class="container">
                <div class="row g-5 align-items-center">
                    ...
                    <div class="col-lg-6 order-1 order-lg-2 text-center" data-aos="fade-up" data-aos-delay="200">
                        <img src="{{asset('img/inpev.png')}}" alt="" style="width: 380px">
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container-xxl py-5-5">
        <div class="container">
            <div class="text-center" data-aos="fade-up" data-aos-delay="200">
                <img src="{{asset('img/about/logos-DVD.png')}}" alt="" style="width: 1000px;">
            </div>
        </div>
    </div>
    <!-- Team End -->
