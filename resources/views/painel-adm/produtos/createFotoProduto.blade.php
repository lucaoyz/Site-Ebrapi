...
<form action="{{ route('produtos.store.fotoProduto', $produto->id) }}" method="POST" enctype="multipart/form-data">
    @csrf
    <div class="card-body">
        @if (session('status'))
        ...
        <div class="mb-3">
            ...
            <input type="file" name="fp_imagem[]" class="form-control" id="fp_imagem" accept=".jpeg,.png,.jpg,.gif,.svg"><br>
            <div class="increment">
    ...
    <div class="card-footer">
        ...
        <a href="{{route('produtos')}}" class="btn btn-secondary">Voltar para os produtos</a>
    </div>
