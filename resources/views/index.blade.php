    ...
    <div class="container-fluid fixed-top px-0 wow fadeIn text-white" data-wow-delay="0.1s">
        <div class="top-bar row gx-0 align-items-center d-none d-lg-flex">
            <div class="col-lg-6 px-5 text-start">
                <small><i class="fa fa-map-marker-alt me-2 text-white"></i>123 Street, New York, USA</small>
                <small class="ms-4"><i class="fa fa-envelope me-2 text-white"></i>info@example.com</small>
            </div>
                ...
                <div class="navbar-nav ms-auto p-4 p-lg-0">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu m-0">
                            <a href="{{route('defensivos')}}" class="dropdown-item">Defensivos Agrícolas</a>
                            <a href="{{route('fertilizantes')}}" class="dropdown-item">Fertilizantes</a>
                            <a href="{{route('biologicos')}}" class="dropdown-item">Biológicos</a>
                            <a href="{{route('sementes')}}" class="dropdown-item">Sementes</a>
                        </div>
                    </div>
